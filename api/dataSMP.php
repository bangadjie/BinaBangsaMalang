...
<head>
    <meta charset="UTF-8">
    <title>Data Pendaftar SMP - Panel Admin</title>
    ...
    <div class="flex min-h-screen">
        ...
        <aside class="w-72 bg-slate-900 text-slate-300 p-6 shadow-xl sticky top-0 h-screen">
            <div class="flex items-center gap-3 mb-10 px-2">
                <div class="bg-green-600 p-2 rounded-lg text-white"> <i class="fas fa-school fa-lg"></i>
                </div>
            ...
            <nav class="space-y-2">
                ...
                <a href="dataSMP.php" class="flex items-center gap-3 p-3 bg-green-600 text-white rounded-xl shadow-lg transition">
            ...
            <header class="mb-8 flex justify-between items-end">
                <div>
                    <nav class="text-sm text-slate-400 mb-2">
                        <a href="Dashboard.php" class="hover:text-blue-600">Admin</a> / <span>Data SMP</span>
                    </nav>
                    <h1 class="text-3xl font-bold text-slate-800">Pendaftar SMP</h1>
                    <p class="text-slate-500">Kelola dan verifikasi data calon siswa Sekolah Menengah Kejuruan.</p>
                </div>

                <a href="ExportExcel.php?type=smp" class="flex items-center gap-2 bg-green-600 hover:bg-green-700 text-white px-5 py-2.5 rounded-xl shadow-md transition font-semibold text-sm">
                        ...
                        <tbody class="text-sm">
                            <?php while ($row = mysqli_fetch_assoc($query_smp)) : ?>
                                <tr class="hover:bg-blue-50/50 transition-colors odd:bg-white even:bg-slate-50/50">
                                    ...
                                    <td class="p-4 border-b whitespace-nowrap text-slate-600">
                                        <div class="font-medium text-slate-800"><?= $row['asalSD']; ?></div>
...
<script>
    function showDetail(data) {
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 text-sm">
            <div class="space-y-4">
                <h4 class="font-bold text-green-600 border-b pb-1 uppercase tracking-wider text-xs">Data Pribadi</h4>
            ...
            <div class="space-y-4">
                <h4 <h4 class="font-bold text-green-600 border-b pb-1 uppercase tracking-wider text-xs">Data Pendidikan & Wali</h4>
                <p><span class="text-slate-400 block text-xs">Asal Sekolah:</span> <span class="font-semibold text-slate-800">${data.asalSD}</span></p>
